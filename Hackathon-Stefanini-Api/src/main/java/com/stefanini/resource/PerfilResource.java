...
public class PerfilResource {
    ...
    public Response obterPerfils() {
        log.info("Obtento lista de perfils");
    ...
    public Response adicionarPerfil(@Valid Perfil perfil) {
        ...
        return Response.status(Response.Status.METHOD_NOT_ALLOWED).entity(new ErroDto("nome","Informe outro nome de perfil este já existe", perfil.getNome())).build();
    }
